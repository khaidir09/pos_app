...
import 'package:flutter_pos_app/data/models/response/summary_response_model.dart';
import 'package:flutter_pos_app/presentation/setting/bloc/report/product_sales/product_sales_bloc.dart';
import 'package:flutter_pos_app/presentation/setting/bloc/report/summary/summary_bloc.dart';
...
class _ReportPageState extends State<ReportPage> {
              ...
              onSelected: (value) async {
                if (value == 'PDF') {
                  ...
                  if (productSales.isNotEmpty && summary != null) {
                    ...
                    final shopInfo = await authLocalDatasource.getShopInfo();
  ...
  List<Widget> _getTitleHeaderWidget() {
    return [
      ...
      _getTitleItemWidget('Produk', 140),
      _getTitleItemWidget('Harga', 140),
      _getTitleItemWidget('Banyaknya', 58),
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                      productSales
                          .totalPrice.toIntegerFromText.currencyFormatRp,
                    ),
                  ),
                ),
              ],
